...
training_set = train_datagen.flow_from_directory(directory='./face-expression-recognition-dataset/images/train',
                                              target_size=(48, 48),
...
test_set = test_datagen.flow_from_directory(directory='./face-expression-recognition-dataset/images/validation',
                                            target_size=(48, 48),
                                            class_mode='categorical',
                                            batch_size=32,
                                            classes=['Angy', 'Disgust', 'Fear',
